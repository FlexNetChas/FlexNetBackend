        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Personality = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    VoiceEnabled = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    VoiceSelection = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "Default")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartedTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
